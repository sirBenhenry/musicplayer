    ...
    TopAppBar(
        ...
        navigationIcon = {
            Row(
                ...
                // Upstream beta badge removed — this is a personal fork, not a beta.
            }
        },
        actions = {
            Row(
                ...
                // Streaming + changelog buttons removed — personal fork: accounts
                // live in Settings, upstream changelog is irrelevant here.
                FilledIconButton(
