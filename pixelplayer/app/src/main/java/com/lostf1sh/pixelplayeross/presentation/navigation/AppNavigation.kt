    ...
    startDestination?.let { initialRoute ->
        NavHost(
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    AccountsScreen(
                        ...
                        onOpenBackendLogin = {
                            navController.navigateSafely(Screen.BackendLogin.route)
                        }
                    )
                }
            }
            composable(
                route = Screen.DailySlot.route,
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    ...
                    if (playlistId != null) {
                        com.lostf1sh.pixelplayeross.presentation.screens.DailySlotScreen(
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.lostf1sh.pixelplayeross.presentation.screens.BackendSearchScreen(
                        onBackClick = { navController.popBackStack() }
                    )
                }
            }
            composable(
                Screen.BackendDownloads.route,
                enterTransition = { enterTransition() },
                exitTransition = { exitTransition() },
                popEnterTransition = { popEnterTransition() },
                popExitTransition = { popExitTransition() },
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.lostf1sh.pixelplayeross.presentation.screens.BackendDownloadsScreen(
                        onBackClick = { navController.popBackStack() }
                    )
                }
            }
            composable(
                Screen.BackendNotifications.route,
                enterTransition = { enterTransition() },
                exitTransition = { exitTransition() },
                popEnterTransition = { popEnterTransition() },
                popExitTransition = { popExitTransition() },
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.lostf1sh.pixelplayeross.presentation.screens.BackendNotificationsScreen(
                        onBackClick = { navController.popBackStack() }
                    )
                }
            }
            composable(
                Screen.BackendLogin.route,
                enterTransition = { enterTransition() },
                exitTransition = { exitTransition() },
                popEnterTransition = { popEnterTransition() },
                popExitTransition = { popExitTransition() },
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.lostf1sh.pixelplayeross.presentation.screens.BackendLoginScreen(
                        onBackClick = { navController.popBackStack() }
                    )
                }
            }
